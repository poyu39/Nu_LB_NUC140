...
void draw_ox_game_now() {
    ...
    for (i = 0; i < 9; i++) {
        if (ooxx[i] == 0) {
            draw_Circle(21 + (i % 3) * 43, 10 + (i / 3) * 21, 8, 0xFFFF, 0x0000);
        } else if (ooxx[i] == 1) {
            draw_Line(2 + (i % 3) * 43, 0 + (i / 3) * 21, 40 + (i % 3) * 43, 18 + (i / 3) * 21, 0xFFFF, 0x0000);
            draw_Line(40 + (i % 3) * 43, 0 + (i / 3) * 21, 2 + (i % 3) * 43, 18 + (i / 3) * 21, 0xFFFF, 0x0000);
        }
    }
}
